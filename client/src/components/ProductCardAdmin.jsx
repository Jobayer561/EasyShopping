...
const ProductCardAdmin = ({ data, fetchProductData }) => {
  ...
  return (
    <div className="w-36 p-4 bg-white rounded flex flex-col justify-between h-64">
      <div>
        ...
        <p className="text-ellipsis line-clamp-2 font-medium min-h-10">
          {data?.name}
        </p>
        <p className="text-slate-400 min-h-6">{data?.unit}</p>
      </div>
