            ...
            <form className="grid gap-4" onSubmit={handleSubmit}>
              <div className="grid gap-1">
                ...
                <input
                  ...
                  required
                  className="bg-blue-50 p-2 outline-none border focus-within:border-[color:#ffbf00] rounded"
                />
              </div>
              <div className="grid gap-1">
                ...
                <textarea
                  ...
                  multiple
                  rows={3}
                  className="bg-blue-50 p-2 outline-none border focus-within:border-[color:#ffbf00] rounded resize-none"
                />
              </div>
              <div>
              ...
              <div
                ...
                className=" hover:bg-[color:#ffbf00] bg-white py-1 px-3 w-32 text-center font-semibold border border-[color:#ffbf00] hover:text-neutral-900 cursor-pointer rounded"
              >
                Add Fields
              </div>

              <button className="bg-[color:#ffc929] hover:bg-[color:#ffbf00] py-2 rounded font-semibold">
                Update Product
              </button>
            </form>
          </div>
